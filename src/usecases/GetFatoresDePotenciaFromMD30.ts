...
export default class GetFatoresDePotenciaFromMD30 {
  ...
  execute(ip: string): Array<MedicaoMD30> {
    ...
    const fatoresDePotenciaWithTimestamp: Array<MedicaoMD30> = medidorMD30.getFatoresDePotenciaWithTimestamps();
    
    return fatoresDePotenciaWithTimestamp;
  }
}